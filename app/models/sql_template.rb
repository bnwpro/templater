class SqlTemplate < ActiveRecord::Base
  ...
  class Resolver < ActionView::Resolver
    ...
    attr_accessor :campaign_document
    def set_campaign_document(id)
    ...
    # Normalize name and prefix, so ["index", "users"] becomes "users/index"
    # and ["template", nil] becomes "template".
